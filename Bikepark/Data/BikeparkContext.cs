...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ItemCategory>().HasData( new ItemCategory { ItemCategoryID = 5, ItemCategoryName = "Электровелосипед" });
            ...
            modelBuilder.Entity<RentalPricing>().HasData(new RentalPricing { RentalPricingID = 1, RentalPricingName = "MTB будний час", PricingCategoryID = 1, RentalType = RentalType.Hourly, DaysOfWeek = WeekDayShort, IsHoliday = false, IsReduced = false, Price = 150 });
            modelBuilder.Entity<RentalPricing>().HasData(new RentalPricing { RentalPricingID = 2, RentalPricingName = "MTB пятница час", PricingCategoryID = 1, RentalType = RentalType.Hourly, DaysOfWeek = Friday, IsHoliday = false, IsReduced = false, Price = 150 });
            modelBuilder.Entity<RentalPricing>().HasData(new RentalPricing { RentalPricingID = 3, RentalPricingName = "MTB выходной час", PricingCategoryID = 1, RentalType = RentalType.Hourly, DaysOfWeek = WeekEnd, IsHoliday = false, IsReduced = false, Price = 200 });
            modelBuilder.Entity<RentalPricing>().HasData(new RentalPricing { RentalPricingID = 4, RentalPricingName = "MTB праздник час", PricingCategoryID = 1, RentalType = RentalType.Hourly, DaysOfWeek = EveryDay, IsHoliday = true, IsReduced = false, Price = 200 });
            modelBuilder.Entity<RentalPricing>().HasData(new RentalPricing { RentalPricingID = 5, RentalPricingName = "MTB льготный час", PricingCategoryID = 1, RentalType = RentalType.Hourly, DaysOfWeek = EveryDay, IsHoliday = false, IsReduced = true, Price = 100 });

            modelBuilder.Entity<RentalPricing>().HasData(new RentalPricing { RentalPricingID = 28, RentalPricingName = "MTB будний 2 часа", PricingCategoryID = 1, RentalType = RentalType.Hourly, DaysOfWeek = WeekDayShort, IsHoliday = false, IsReduced = false, Price = 250/2, MinDuration = 2, ExtraPrice = 150});
            modelBuilder.Entity<RentalPricing>().HasData(new RentalPricing { RentalPricingID = 29, RentalPricingName = "MTB пятница 2 часа", PricingCategoryID = 1, RentalType = RentalType.Hourly, DaysOfWeek = Friday, IsHoliday = false, IsReduced = false, Price = 250/2, MinDuration = 2, ExtraPrice = 150 });
            modelBuilder.Entity<RentalPricing>().HasData(new RentalPricing { RentalPricingID = 30, RentalPricingName = "MTB выходной 2 часа", PricingCategoryID = 1, RentalType = RentalType.Hourly, DaysOfWeek = WeekEnd, IsHoliday = false, IsReduced = false, Price = 300/2, MinDuration = 2, ExtraPrice = 200 });
            modelBuilder.Entity<RentalPricing>().HasData(new RentalPricing { RentalPricingID = 31, RentalPricingName = "MTB праздник 2 часа", PricingCategoryID = 1, RentalType = RentalType.Hourly, DaysOfWeek = EveryDay, IsHoliday = true, IsReduced = false, Price = 300/2, MinDuration = 2, ExtraPrice = 200 });
            modelBuilder.Entity<RentalPricing>().HasData(new RentalPricing { RentalPricingID = 32, RentalPricingName = "MTB льготный 2 часа", PricingCategoryID = 1, RentalType = RentalType.Hourly, DaysOfWeek = EveryDay, IsHoliday = false, IsReduced = true, Price = 150/2, MinDuration = 2, ExtraPrice = 100 });

            modelBuilder.Entity<RentalPricing>().HasData(new RentalPricing { RentalPricingID = 6, RentalPricingName = "MTB будний день", PricingCategoryID = 1, RentalType = RentalType.Daily, DaysOfWeek = WeekDayShort, IsHoliday = false, IsReduced = false, Price = 800 });
            modelBuilder.Entity<RentalPricing>().HasData(new RentalPricing { RentalPricingID = 7, RentalPricingName = "MTB пятница день", PricingCategoryID = 1, RentalType = RentalType.Daily, DaysOfWeek = Friday, IsHoliday = false, IsReduced = false, Price = 1000 });
            modelBuilder.Entity<RentalPricing>().HasData(new RentalPricing { RentalPricingID = 8, RentalPricingName = "MTB выходной день", PricingCategoryID = 1, RentalType = RentalType.Daily, DaysOfWeek = WeekEnd, IsHoliday = false, IsReduced = false, Price = 1000 });
            modelBuilder.Entity<RentalPricing>().HasData(new RentalPricing { RentalPricingID = 9, RentalPricingName = "MTB праздник день", PricingCategoryID = 1, RentalType = RentalType.Daily, DaysOfWeek = EveryDay, IsHoliday = true, IsReduced = false, Price = 1000 });
            modelBuilder.Entity<RentalPricing>().HasData(new RentalPricing { RentalPricingID = 10, RentalPricingName = "MTB льготный день", PricingCategoryID = 1, RentalType = RentalType.Daily, DaysOfWeek = EveryDay, IsHoliday = false, IsReduced = true, Price = 400 });

            modelBuilder.Entity<RentalPricing>().HasData(new RentalPricing { RentalPricingID = 11, RentalPricingName = "MTB подросток будний час", PricingCategoryID = 2, RentalType = RentalType.Hourly, DaysOfWeek = WeekDayShort, IsHoliday = false, IsReduced = false, Price = 100 });
            modelBuilder.Entity<RentalPricing>().HasData(new RentalPricing { RentalPricingID = 12, RentalPricingName = "MTB подросток пятница час", PricingCategoryID = 2, RentalType = RentalType.Hourly, DaysOfWeek = Friday, IsHoliday = false, IsReduced = false, Price = 100 });
            modelBuilder.Entity<RentalPricing>().HasData(new RentalPricing { RentalPricingID = 13, RentalPricingName = "MTB подросток выходной час", PricingCategoryID = 2, RentalType = RentalType.Hourly, DaysOfWeek = WeekEnd, IsHoliday = false, IsReduced = false, Price = 150 });
            modelBuilder.Entity<RentalPricing>().HasData(new RentalPricing { RentalPricingID = 14, RentalPricingName = "MTB подросток праздник час", PricingCategoryID = 2, RentalType = RentalType.Hourly, DaysOfWeek = EveryDay, IsHoliday = true, IsReduced = false, Price = 150 });
            modelBuilder.Entity<RentalPricing>().HasData(new RentalPricing { RentalPricingID = 15, RentalPricingName = "MTB подросток льготный час", PricingCategoryID = 2, RentalType = RentalType.Hourly, DaysOfWeek = EveryDay, IsHoliday = false, IsReduced = true, Price = 50 });

            modelBuilder.Entity<RentalPricing>().HasData(new RentalPricing { RentalPricingID = 16, RentalPricingName = "MTB подросток будний день", PricingCategoryID = 2, RentalType = RentalType.Hourly, DaysOfWeek = WeekDayShort, IsHoliday = false, IsReduced = false, Price = 500 });
            modelBuilder.Entity<RentalPricing>().HasData(new RentalPricing { RentalPricingID = 17, RentalPricingName = "MTB подросток пятница день", PricingCategoryID = 2, RentalType = RentalType.Hourly, DaysOfWeek = Friday, IsHoliday = false, IsReduced = false, Price = 600 });
            modelBuilder.Entity<RentalPricing>().HasData(new RentalPricing { RentalPricingID = 18, RentalPricingName = "MTB подросток выходной день", PricingCategoryID = 2, RentalType = RentalType.Hourly, DaysOfWeek = WeekEnd, IsHoliday = false, IsReduced = false, Price = 700 });
            modelBuilder.Entity<RentalPricing>().HasData(new RentalPricing { RentalPricingID = 19, RentalPricingName = "MTB подросток праздник день", PricingCategoryID = 2, RentalType = RentalType.Hourly, DaysOfWeek = EveryDay, IsHoliday = true, IsReduced = false, Price = 700 });
            modelBuilder.Entity<RentalPricing>().HasData(new RentalPricing { RentalPricingID = 20, RentalPricingName = "MTB подросток льготный день", PricingCategoryID = 2, RentalType = RentalType.Hourly, DaysOfWeek = EveryDay, IsHoliday = false, IsReduced = true, Price = 300 });

            modelBuilder.Entity<RentalPricing>().HasData(new RentalPricing { RentalPricingID = 21, RentalPricingName = "BMX будний час", PricingCategoryID = 3, RentalType = RentalType.Hourly, DaysOfWeek = WeekDayShort, IsHoliday = false, IsReduced = false, Price = 100 });
            modelBuilder.Entity<RentalPricing>().HasData(new RentalPricing { RentalPricingID = 22, RentalPricingName = "BMX пт-сб-вс час", PricingCategoryID = 3, RentalType = RentalType.Hourly, DaysOfWeek = WeekEndLong, IsHoliday = false, IsReduced = false, Price = 150 });
            modelBuilder.Entity<RentalPricing>().HasData(new RentalPricing { RentalPricingID = 23, RentalPricingName = "BMX праздник час", PricingCategoryID = 3, RentalType = RentalType.Hourly, DaysOfWeek = EveryDay, IsHoliday = true, IsReduced = false, Price = 150 });
            modelBuilder.Entity<RentalPricing>().HasData(new RentalPricing { RentalPricingID = 24, RentalPricingName = "Беговел час", PricingCategoryID = 4, RentalType = RentalType.Hourly, DaysOfWeek = EveryDay, IsHoliday = false, IsReduced = false, Price = 100 });
            modelBuilder.Entity<RentalPricing>().HasData(new RentalPricing { RentalPricingID = 25, RentalPricingName = "Электро час", PricingCategoryID = 5, RentalType = RentalType.Hourly, DaysOfWeek = EveryDay, IsHoliday = false, IsReduced = false, Price = 300 });
            modelBuilder.Entity<RentalPricing>().HasData(new RentalPricing { RentalPricingID = 26, RentalPricingName = "Аксессуар час", PricingCategoryID = 6, RentalType = RentalType.Hourly, DaysOfWeek = EveryDay, IsHoliday = false, IsReduced = false, Price = 50 });
            modelBuilder.Entity<RentalPricing>().HasData(new RentalPricing { RentalPricingID = 27, RentalPricingName = "Аксессуар день", PricingCategoryID = 6, RentalType = RentalType.Daily, DaysOfWeek = EveryDay, IsHoliday = false, IsReduced = false, Price = 300 });
