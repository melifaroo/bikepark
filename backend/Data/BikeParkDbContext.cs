...
namespace Bikepark.Data
{
    public class BikeparkDbContext : IdentityDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Item>().HasData(new Item { ItemID = 1, Number = 1, CategoryID = 1, SubCategoryID = 1, Name = "Mongoose", Size = 20, Status = ItemStatus.Ready });
        
            modelBuilder.Entity<Item>().HasData(new Item { ItemID = 2, Number = 2, CategoryID = 1, SubCategoryID = 1, Name = "Mongoose", Size = 20, Status = ItemStatus.Ready });
        
            modelBuilder.Entity<Item>().HasData(new Item { ItemID = 3, Number = 3, CategoryID = 1, SubCategoryID = 1, Name = "Mongoose", Size = 30, Status = ItemStatus.Ready });
        
            modelBuilder.Entity<Item>().HasData(new Item { ItemID = 4, Number = 4, CategoryID = 1, SubCategoryID = 1, Name = "GT", Size = 40, Status = ItemStatus.Ready });

            modelBuilder.Entity<Item>().HasData(new Item { ItemID = 5, Number = 5, CategoryID = 1, SubCategoryID = 1, Name = "GT", Size = 40, Status = ItemStatus.Ready });

            modelBuilder.Entity<Item>().HasData(new Item { ItemID = 6, Number = 1, CategoryID = 1, SubCategoryID = 2, Name = "GT", Status = ItemStatus.Ready});

            modelBuilder.Entity<Item>().HasData(new Item { ItemID = 7, Number = 2, CategoryID = 1, SubCategoryID = 2, Name = "GT", Status = ItemStatus.Ready});
        }
