...
namespace backend.Data.Migrations
{
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "RentalLog",
                columns: new[] { "RentalRecordID", "ActualEnd", "CustomInformation", "CustomerID", "End", "RentalStatus", "RentalType", "Start" },
            ...
            migrationBuilder.InsertData(
                table: "RentalLog",
                columns: new[] { "RentalRecordID", "ActualEnd", "CustomInformation", "CustomerID", "End", "RentalStatus", "RentalType", "Start" },
                values: new object[] { 1, null, null, 1, new DateTime(2022, 4, 19, 12, 0, 0, 0, DateTimeKind.Unspecified), 2, 1, new DateTime(2022, 4, 19, 9, 0, 0, 0, DateTimeKind.Unspecified) });

            migrationBuilder.InsertData(
                table: "RentalLog",
                columns: new[] { "RentalRecordID", "ActualEnd", "CustomInformation", "CustomerID", "End", "RentalStatus", "RentalType", "Start" },
                values: new object[] { 2, null, null, 2, new DateTime(2022, 4, 30, 19, 0, 0, 0, DateTimeKind.Unspecified), 0, 1, new DateTime(2022, 4, 30, 16, 0, 0, 0, DateTimeKind.Unspecified) });

            migrationBuilder.InsertData(
                table: "RentalLog",
                columns: new[] { "RentalRecordID", "ActualEnd", "CustomInformation", "CustomerID", "End", "RentalStatus", "RentalType", "Start" },
                values: new object[] { 3, null, null, 1, new DateTime(2022, 4, 30, 19, 0, 0, 0, DateTimeKind.Unspecified), 0, 1, new DateTime(2022, 4, 30, 16, 0, 0, 0, DateTimeKind.Unspecified) });

            migrationBuilder.InsertData(
                table: "RentalLog",
                columns: new[] { "RentalRecordID", "ActualEnd", "CustomInformation", "CustomerID", "End", "RentalStatus", "RentalType", "Start" },
                values: new object[] { 4, null, null, 1, new DateTime(2022, 5, 1, 14, 0, 0, 0, DateTimeKind.Unspecified), 0, 1, new DateTime(2022, 5, 1, 10, 0, 0, 0, DateTimeKind.Unspecified) });

            migrationBuilder.InsertData(
                table: "RentalLog",
                columns: new[] { "RentalRecordID", "ActualEnd", "CustomInformation", "CustomerID", "End", "RentalStatus", "RentalType", "Start" },
                values: new object[] { 5, null, null, 2, new DateTime(2022, 5, 1, 8, 0, 0, 0, DateTimeKind.Unspecified), 1, 2, new DateTime(2022, 4, 30, 8, 0, 0, 0, DateTimeKind.Unspecified) });
            ...
            migrationBuilder.InsertData(
                table: "RentalItem",
                columns: new[] { "RentalItemID", "ActualEnd", "End", "IsPaid", "ItemID", "RentalPricingID", "RentalRecordID", "RentalStatus", "RentalType", "Start" },
